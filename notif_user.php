...
<div class="container-fluid container-xl d-flex align-items-center justify-content-between">
  ...
  <section class="sectionprofile">
    <div style="display: flex; align-items: center;">
        ...
        <h3 style="margin-left: 10px"><b>Notifikasi</b></h3>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="boxprofile" style="width: 100%;">
                        <h3 style="text-align: start; font-size: 20px;"><b>Pengingat</b></h3>
                        <div class="boxp2">
                            <div class="btnpu" style="background-color:#060606; border:none; display: flex; align-items: center; margin-bottom: 10px; border-radius:10px;">
                                <span style="flex: 1; text-align: start;">1 jam sebelum puasa dimulai</span>
                                <label class="switch">
                                    <input type="checkbox">
                            ...
                            <div class="btnpu" style="background-color:#060606; border:none; display: flex; align-items: center; margin-bottom: 10px; border-radius:10px;">
                                <span style="flex: 1; text-align: start;">Mulai Puasa</span>
                                <label class="switch">
                                    <input type="checkbox">
                                    <span class="slider round"></span>
                                </label>
                            </div>
                            <hr style="height: 5px; background-color: #FECA00;">
                            <div class="btnpu" style="background-color:#060606; border:none; display: flex; align-items: center; margin-bottom: 10px; border-radius:10px;">
                                <span style="flex: 1; text-align: start;">1 jam sebelum puasa berakhir</span>
                                <label class="switch">
                                    <input type="checkbox">
                                    <span class="slider round"></span>
                                </label>
                            ...
                            <div class="btnpu" style="background-color:#060606; border:none; display: flex; align-items: center; margin-bottom: 10px; border-radius:10px;">
                                <span style="flex: 1; text-align: start;">Puasa Berakhir</span>
                                <label class="switch">
                                    <input type="checkbox">
                                    <span class="slider round"></span>
                                </label>
