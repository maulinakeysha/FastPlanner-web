                    ...
                    <div class="boxprofile" style="width: 100%;">
                        ...
                        <div class="boxp2">
                            <div class="input-container" style="display: flex; align-items: center; border-radius: 50px;  background-color: #060606; margin-bottom:10px;">
                                ...
                                <input value="<?= $userPremium->nama ?>" type="text" id="username" name="username" class="form-control form-control-lg" placeholder="Name" style="width: 100%; background-color:#060606; color:white; outline: none; border: none; max-width:85%; ">
                            </div>
                            <div class="input-container" style="display: flex; align-items: center; border-radius: 50px;  background-color: #060606; margin-bottom:10px;">
                                <img src="assets/img/birthday.svg" style="margin-left: 10px;">
                                <input value="<?= $userPremium->usia ?>" type="text" id="age" name="age" class="form-control form-control-lg" placeholder="Age" style="width: 100%; background-color:#060606; color:white; outline: none; border: none; max-width:85%;">
                            </div>
                            <div class="input-container" style="display: flex; align-items: center; border-radius: 50px;  background-color: #060606; margin-bottom:10px;">
                                <img src="assets/img/gender.svg" style="margin-left: 10px;">
                                <select id="gender" name="gender" class="form-control form-control-lg" style="width: 100%; background-color: #060606; color: white; outline: none; border: none; max-width: 85%;">
                            ...
                            <div class="input-container" style="display: flex; align-items: center; border-radius: 50px;  background-color: #060606; margin-bottom:10px;">
                                ...
                                <input value="<?= $userPremium->berat_badan ?>" type="text" id="weight" name="weight" class="form-control form-control-lg" placeholder="Weight" style="width: 100%; background-color:#060606; color:white; outline: none; border: none; max-width:80%;">
                                <span style="margin-left:10px; text-align: right;">(kg)</span>
                            </div>
                            <div class="input-container" style="display: flex; align-items: center; border-radius: 50px;  background-color: #060606; margin-bottom:10px;">
                                <img src="assets/img/height.svg" style="margin-left: 10px;">
                                <input value="<?= $userPremium->tinggi_badan ?>" type="text" id="height" name="height" class="form-control form-control-lg" placeholder="Height" style="width: 100%; background-color:#060606; color:white; outline: none; border: none; max-width:80%;">
                                <span style="margin-left:8px; text-align: end;">(cm)</span>
                            </div>
                            <h3 style="text-align: center; font-size: 20px; margin-top:20px; margin-bottom:20px;"><b>Personal Target</b></h3>
                            <div class="input-container" style="display: flex; align-items: center; border-radius: 50px;  background-color: #060606; margin-bottom:10px;">
                                <img src="assets/img/weight.svg" style="margin-left: 10px;">
                                <input type="text" id="weight" name="weigh" class="form-control form-control-lg" placeholder="Weight" style="width: 100%; background-color:#060606; color:white; outline: none; border: none; max-width:80%;">
                                <span style="margin-left:10px; text-align: end;">(kg)</span>
                            </div>
