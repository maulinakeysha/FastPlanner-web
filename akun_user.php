...
<body>
  ...
  <!-- Profile -->
    <section class="sectionprofile">
        <h3 style="margin-left: 90px;"><b><a href="profile_user.php" style="color: white;">Profile</a> > Informasi Akun</b></h3>
                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        <div class="boxprofile">
                            <img src="assets/img/profile.svg" class="img-fluid rounded-4 md-my-5" alt="profile user">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="boxprofile" style="width: 100%;">
                            <h3 style="text-align: start; font-size: 20px;"><b>Informasi Akun</b></h3>
                            <!-- <div class="boxdata"> -->
                                <h2 class="btnpu" style="display: flex; align-items: center;">
                                    <img src="assets/img/iconp.svg" style="float: left; margin-right: 5px;">
                                    <span style="flex: 1; text-align: start;"><?= $userPremium->username ?></span>
                                </h2>
                                <h2 class="btnpu" style="display: flex; align-items: center;">
                                    <img src="assets/img/phone.svg" style="float: left; margin-right: 5px;">
                                    <span style="flex: 1; text-align: start;"><?= $userPremium->telepon ?></span>
                                </h2>
                                <h2 class="btnpu" style="display: flex; align-items: center; text-align: left;">
                                    <img src="assets/img/email.svg" style="float: left; margin-right: 5px;">
                                    <span style="flex: 1; text-align: start;"><?= $userPremium->email ?></span>
                                </h2>
                                <h3 style="text-align: center; font-size: 18px;"><b>Security setting</b></h3>
                                <a href="gantipw?username=<?= $_SESSION['username']?>" class="btnpu" style="display: flex; align-items: center; margin-bottom: 10px;">
                                    <span style="flex: 1; text-align: start;">Ganti sandi</span>
                                    <img src="assets/img/key.svg" style="float: right; margin-left: 5px;">
                                </a>
                                <a href="profile_user" class="btn btn-warning rounded-3">Kembali</a>
                            <!-- </div> -->
                        </div>
